...
static const Rule rules[] = {
	...
	RULE(.class = "Gimp", .tags = 1 << 4)
	RULE(.class = "Firefox", .tags = 1 << 7)
	RULE(.class = "Develop window", .isfloating = 1)
	#if RENAMED_SCRATCHPADS_PATCH
...
static const char mictogglecmd[] = "bash /home/sephix/Scripts/mic.sh; kill -45 $(pidof dwmblocks)";
static const char volupsig[]     = "pactl set-sink-volume 0 +5%; kill -44 $(pidof dwmblocks)";
static const char voldownsig[]   = "pactl set-sink-volume 0 -5%; kill -44 $(pidof dwmblocks)";
...
static const Key keys[] = {
	...
	{ WINKEY,                       XK_z,          spawn,                  SHCMD(mictogglecmd)  },
	{ WINKEY,                       XK_y,          spawn,                  SHCMD(volupsig)      },
	{ WINKEY,                       XK_u,          spawn,                  SHCMD(voldownsig)    },
	#if RIODRAW_PATCH
